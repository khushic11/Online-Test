...
<h1 class="text-center text-white font-weight-bold text-uppercase bg-dark" >  SUBTLE ONLINE TEST </h1><br>
      <div class="container ">
        ...
        <div class="container">
            <!-- <h1 class="text-center text-primary">Subtle Online Test</h1> -->

            <!-- <div class=" col-lg-12 text-center text-primary"> -->
               <!-- <h3> <a href="#" class="text-uppercase text-warning animateuse" ></a>Subtle Online Test -->
               <!-- </h3> -->
               <!-- <h1 class="text-center text-white font-weight-bold text-uppercase bg-dark" >  Welcome to Subtle Online Test </h1><br> -->
        ...
        <!-- <div class="col=xl-8 col-lg-8 col-md-8 col-sm-8  m-auto d-block"> -->
               <!-- <div class="card"> -->
                  <!-- <p class="card-header text-center" > , you have to select only one out of 4. Best of Luck <i class="fas fa-thumbs-up"></i>	 </p> -->
            <!-- </div> -->
            <!-- <br> -->
...
<div class=" col-lg-12 text-center">
     ...
     <form action="check1.php" method="post">
          ...
          for ($i=1; $i < 11;$i++ ) { 
            ...
            $q = "select * from questions4 where qid=$i";
            ...
            while ($rows = mysqli_fetch_array($query)) {
                ...
                <?php
                $q = "select * from answers5 where ans_id=$i";
                $query = mysqli_query($conn,$q);
                while ($rows = mysqli_fetch_array($query)) {
                    ?>
                <div class="card-body">
        ...
        <input type="submit" name="submit" value="Submit" class="btn btn-success m-auto d-block"><a href="check1.php" ></a>
        </form>
        </div>
        </div>
