  ...
  <div class="grid-container">
    ...
    <aside id="sidebar">
      ...
      <ul class="sidebar-list">
        ...
        <li class="sidebar-list-item">
          <span class="material-icons-outlined">poll</span><a href="check1.php" style="text-decoration: none;color: #9799ab;"> Result</a>
        </li>
...
<div class="card">
  ...
  $selected = $_POST['quizcheck'];
    ...
    if (($i<2 && $i>11) || $result==0 )
    echo "<script>alert('Do attemp all questions');window.location.href=' quiz2.php '</script>";
  ...
  $name = $_SESSION['user_name'];
            $finalresult = " insert into user2(username,totalques,attemptedques,answerscorrect,wrongques,review) values ('$name','10','$count','$result','$wrong','') ";
