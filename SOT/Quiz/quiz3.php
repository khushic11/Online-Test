...
<div class=" col-lg-12 text-center">
     ...
     <form action="check2.php" method="post">
          ...
          for ($i=1; $i < 11;$i++ ) { 
            ...
            $q = "select * from questions3 where qid=$i";
            ...
            while ($rows = mysqli_fetch_array($query)) {
                ...
                <?php
                $q = "select * from answers3 where ans_id=$i";
                $query = mysqli_query($conn,$q);
                while ($rows = mysqli_fetch_array($query)) {
                    ?>
                <div class="card-body">
        ...
        <input type="submit" name="submit" value="Submit" class="btn btn-success m-auto d-block"><a href="check2.php" ></a>
        </form>
        </div>
        </div>
